...
// Hedera Testnet specific contract addresses
// This object copies NEW_CONTRACT_ADDRESSES and updates only the FAUCET address
export const HEDERA_TESTNET_CONTRACT_ADDRESSES = {
  ...NEW_CONTRACT_ADDRESSES, // Copy all addresses from NEW_CONTRACT_ADDRESSES
  FAUCET: "0xeabEdd6241A4E00f44b18Ec9e371d97311CF1242", // Override FAUCET address for Hedera Testnet
}
...
export const MULTI_NETWORK_CONTRACTS = {
  ...
  [NETWORKS.HEDERA_TESTNET.chainId]: HEDERA_TESTNET_CONTRACT_ADDRESSES, // Mapped to Hedera specific addresses
